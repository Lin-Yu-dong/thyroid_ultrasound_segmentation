...
def train(config, train_loader, model, criterion, optimizer):
    ...
    for input, target, _ in train_loader:
        ...
        if config['deep_supervision']:
            ...
            output = model(input)
            # only for segformer model, otherwise remove below line for resizing if use another model
...
def main():
    ...
    # Data loading code
    train_img_ids = glob(os.path.join('//home/analysis-user/Documents/Thyroid_project/segmentationcode/data/fold0/train', 'image', '*'))
    train_img_ids = [os.path.splitext(os.path.basename(p))[0] for p in train_img_ids]

    val_img_ids = glob(os.path.join('/home/analysis-user/Documents/Thyroid_project/segmentationcode/data/fold0/val/', 'mask', '*'))
    ...
    train_dataset = Dataset(
        ...
        img_dir=os.path.join('/home/analysis-user/Documents/Thyroid_project/segmentationcode/data/fold0/train/', 'image'),
        mask_dir=os.path.join('/home/analysis-user/Documents/Thyroid_project/segmentationcode/data/fold0/train/', 'mask'),
    ...
    val_dataset = Dataset(
        img_ids=val_img_ids,
        img_dir=os.path.join('/home/analysis-user/Documents/Thyroid_project/segmentationcode/data/fold0/val/','image'),
        mask_dir=os.path.join('/home/analysis-user/Documents/Thyroid_project/segmentationcode/data/fold0/val/', 'mask'),
        img_ext=config['img_ext'],
        mask_ext=config['mask_ext'],
        num_classes=config['num_classes'],

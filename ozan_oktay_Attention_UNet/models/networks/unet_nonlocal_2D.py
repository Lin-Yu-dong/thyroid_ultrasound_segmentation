...
# 下面一行的 utils.py 位置在 DL/ozan_oktay_Attention_UNet/models/networks/utils.py
from .utils import unetConv2, unetUp   

from ozan_oktay_Attention_UNet.models.networks_other import init_weights # 我添加了 ozan_oktay_Attention_UNet.

from ozan_oktay_Attention_UNet.models.layers.nonlocal_layer import NONLocalBlock2D # 这行是我添加的 
import torch.nn.functional as F


class unet_nonlocal_2D(nn.Module): # 对于模型 attention_224_500epoch，我使用此 class类
